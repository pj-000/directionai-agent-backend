...
This repository is the new AI backend baseline for DirectionAI.

It is bootstrapped from DeerFlow 2.0 and will be used to rebuild:

- lesson plan generation
- exam generation
- PPT generation
- compatibility APIs for the existing DirectionAI frontend
...
- [docs/bug-policy.md](./docs/bug-policy.md)

Current migration sources:

- legacy monorepo: `/Users/sss/directionai/DirectionAICloud`
- mature PPT subsystem baseline: `/Users/sss/directionai/directionai_pptagent`

Implementation strategy:

1. keep the current frontend behavior stable
2. rebuild lesson and exam flows on top of DeerFlow orchestration
3. integrate PPT as a specialized subsystem instead of flattening it into generic agent prompts
4. expose compatibility routes and SSE contracts expected by the existing frontend

The original upstream DeerFlow README starts below.
